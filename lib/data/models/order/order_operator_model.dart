// lib/data/models/order/order_operator_model.dart
...
/// Response model cho API Operator - listOrder
class OperatorOrderListResponse extends BaseModel {
  final int statusCode;
  final String message;
  final OperatorOrderData? data;

  OperatorOrderListResponse({
    required this.statusCode,
    required this.message,
    this.data,
  });

  factory OperatorOrderListResponse.fromJson(Map<String, dynamic> json) {
    return OperatorOrderListResponse(
      statusCode: json['statusCode'] ?? 0,
      message: json['message'] ?? '',
      data: json['data'] != null
          ? OperatorOrderData.fromJson(json['data'])
          : null,
    );
  }
...
/// Model cho từng order trong listOrder (Full fields)
class OperatorOrderModel extends BaseModel {
  final int orderID;
  ...
  // Convert to common OrderApiModel for UI compatibility
  OrderApiModel toOrderApiModel() {
    return OrderApiModel(
      ...
      orderDate: orderDate,
      totalCost: totalCost,
      customerPhone: null, // API mới không có phone
      customerAddress: null, // API mới không có address
      notes: null, // API mới không có notes
    );
  }
}